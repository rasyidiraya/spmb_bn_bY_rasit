...
<head>
  ...
  <meta name="auth-status" content="{{ Auth::guard('pengguna')->check() || Auth::guard('admin')->check() || Auth::guard('verifikator')->check() || Auth::guard('keuangan')->check() || Auth::guard('kepsek')->check() ? 'true' : 'false' }}">
