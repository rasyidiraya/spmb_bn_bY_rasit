...
<head>
    ...
    <meta name="auth-status" content="{{ Auth::guard('verifikator')->check() ? 'true' : 'false' }}">

    <title>SPMB Verifikator Administrasi</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        @include('verifikator-administrasi.partials.sidebar')
        <!-- End of Sidebar -->

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            @yield('content-verifikator')
            
            <!-- Footer -->
            @include('verifikator-administrasi.partials.footer')
            <!-- End of Footer -->
        </div>
